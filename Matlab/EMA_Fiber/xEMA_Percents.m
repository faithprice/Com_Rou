...
where = strcat(' WHERE E.s_info_windcode=M.s_con_windcode AND M.s_info_windcode=','''',Index_Code,'''',' AND E.trade_dt>=M.s_con_indate AND(M.cur_sign=1 OR E.trade_dt<=M.s_con_outdate)');
...
fprintf('Index : %s, Total number of trading dates is %d .\n',Index_Code,td_count);
